...
export default function Home(){
    const [title, setTitle] = useState('Adele');
    ...
    return (
        <div className="flex flex-col md:px-12 px-0 relative bg-background font-poppins items-center min-h-screen">
            <h1 className="text-6x1 font-bold text-primary mt-10">
                <span className="text-active">Lyrics</span> App
            </h1>
            <h2 className="text-primary text-2x1 font-light mt-6">
    ...
    >
                <input type="text"className="flex w-full sm:w-1/3 rounded-lg px-5 py-3 text-base text-background font"placeholder="Enter a track or artist name eg: Adele"
                onChange={e => {
                        ...
                        <div className="=flow-root bg-light rounded-lg px-4 pb-8">
                            <div className="-mt-6">
                                ...
                                <div className="text-center justify-center items-center">
                                    ...
                                    <button className="mt-5 text-md text-active" onClick={() => { getLyrics(song.result.id); }}>
                                        Get Lyrics &rarr;
